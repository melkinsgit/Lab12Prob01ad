...
//            resultSet.moveToInsertRow();  // adds a PK value
//            resultSet.updateString(HoneyDatabase.TITLE_COLUMN, title);
//            resultSet.updateInt(HoneyDatabase.YEAR_COLUMN, year);
//            resultSet.updateInt(HoneyDatabase.RATING_COLUMN, rating);
